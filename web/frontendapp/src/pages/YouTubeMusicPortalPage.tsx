...
const YouTubeMusicPortalPage: React.FC = () => {
  ...
  const [showLicensingTab, setShowLicensingTab] = useState(false);
  const [showMetadataBulkEditModal, setShowMetadataBulkEditModal] = useState(false);
  ...
  const handleEditTrack = (track: TrackWithEarnings) => {
    setFormData({
      ...
      tiktokUrl: (track as any).tiktokUrl || '',
      instagramReelUrl: (track as any).instagramReelUrl || '',
      bandcampUrl: (track as any).bandcampUrl || '',
  ...
  return (
    <Container maxWidth="lg" padding="lg">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: theme.spacing.md }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: theme.spacing.md }}>
                <div>
                  ...
                  <input
                    type="text"
                    value={formData.metadata?.isrcCode || ''}
                    onChange={(e) => setFormData({
                      ...formData,
                      metadata: { ...formData.metadata, isrcCode: e.target.value },
                    })}
                    style={{
                      width: '100%',
                      padding: theme.spacing.sm,
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={formData.metadata?.publishingMemberId || ''}
                    onChange={(e) => setFormData({
                      ...formData,
                      metadata: { ...formData.metadata, publishingMemberId: e.target.value },
                    })}
                    style={{
                      width: '100%',
                      padding: theme.spacing.sm,
                    ...
                    placeholder="Publishing member number"
                  />
                </div>
              </div>
        ...
        <div style={{
          ...
          <Card style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: theme.spacing.lg }}>
              ...
              <button
                onClick={() => setShowMetadataBulkEditModal(false)}
                style={{
                  background: 'none',
                  border: 'none',
                  fontSize: '28px',
            ...
            <div style={{ overflowX: 'auto', marginBottom: theme.spacing.lg }}>
              <table style={{
                ...
                <thead>
                  <tr style={{ borderBottom: `2px solid ${theme.colors.gray[800]}` }}>
                    <th style={{ textAlign: 'left', padding: theme.spacing.md, color: theme.colors.text.secondary, fontWeight: 600 }}>
                      Artist
                    </th>
                    <th style={{ textAlign: 'left', padding: theme.spacing.md, color: theme.colors.text.secondary, fontWeight: 600 }}>
                      Song Title
                    ...
                    <th style={{ textAlign: 'center', padding: theme.spacing.md, color: theme.colors.text.secondary, fontWeight: 600 }}>
                      Action
                    </th>
                  </tr>
                </thead>
                      ...
                      <td style={{ padding: theme.spacing.md, textAlign: 'center' }}>
                        <button
                          onClick={() => {
                            ...
                            setShowMetadataBulkEditModal(false);
                          }}
                          style={{
      ...
      {/* Search & Actions */}
      <div style={{ marginBottom: theme.spacing.lg, display: 'flex', gap: theme.spacing.md, alignItems: 'center' }}>
        <input
          type="text"
        ...
        {tracks.length > 0 && (
          <button
            onClick={() => setShowMetadataBulkEditModal(true)}
            style={{
              padding: `${theme.spacing.md} ${theme.spacing.lg}`,
              borderRadius: theme.borderRadius.md,
              border: 'none',
